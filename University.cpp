...
Triple <List <std::pair <Student, float>>, List <std::pair <Student, float>>, List <std::pair <Student, float>>> University::split (const std::string group, const unsigned short session) {
